...
function CardHolderSearch({ pathUrl, propValue }) {
    ...
    const handleClick = () => {
        ...
        navigate(`/genre/${pathUrl}/${propValue.title}`, { state: {data, pathUrl}  });
    }
    ...
    return (
        ...
        >
            ...
            <CardContent sx={{
                ...
                <Typography variant='h7'>{propValue.title}</Typography>
            </CardContent>
        </Card>
